...
sed -i '237,$s#<type name="utf8" c:type="gchar\*\*"/>#<array c:type="const char \*\*"> <type name="utf8"/> </array>#g' GLib-2.0.gir
sed -i 's#<type name="utf8" c:type="const gchar\*\*"/>#<array c:type="const char \*\*"> <type name="utf8"/> </array>#g' GLib-2.0.gir
sed -i 's#<type name="utf8" c:type="const gchar\* const\*"/>#<array c:type="const char \*\*"> <type name="utf8"/> </array>#g' GLib-2.0.gir
sed -i 's#<type name="utf8" c:type="const char\* const\*"/>#<array c:type="const char \*\*"> <type name="utf8"/> </array>#g' GLib-2.0.gir
sed -i 's/type name="utf8" c:type="char"/type name="gchar" c:type="char"/g' HarfBuzz-0.0.gir
sed -i 's#<type name="utf8" c:type="const char\*\*"/>#<array c:type="const char \*\*"> <type name="utf8"/> </array>#g' HarfBuzz-0.0.gir
# introspectable="0"
